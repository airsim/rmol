#ifndef __STDAIR_CPPUNITCORE_HPP
#define __STDAIR_CPPUNITCORE_HPP
...
int main (int argc, char* argv[]) {  \
  ...
  return STDAIR::CppUnitCore (xmlOutputFile.c_str()).main(argc, argv); \
}
// /////////// (END OF)  MACROS /////////////
...
#endif // __STDAIR_CPPUNITCORE_HPP
