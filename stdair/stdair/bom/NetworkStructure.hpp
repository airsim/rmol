#ifndef __STDAIR_BOM_NETWORKSTRUCTURE_HPP
#define __STDAIR_BOM_NETWORKSTRUCTURE_HPP
...
namespace stdair {
  ...
  /** Wrapper class aimed at holding the actual content, modeled
      by an external specific Network class (for instance,
      in the AIRSCHED library). */
  template <class BOM_CONTENT>
  class NetworkStructure : public BomStructure {
  ...
  public:
    ...
    /** Definition allowing to retrieve the  key type of the
        ContentChild_T. */
    typedef NetworkDateKey_T ChildKey_T;
    ...
    typedef boost::mpl::vector<NetworkDateStructure<ContentChild_T>,
  ...
  public:
    ...
    /** Get the holder of network-dates. */
  ...
  private:
    ...
    NetworkStructure () : _parent (NULL), _content (NULL),
                          _childrenHolder (NULL)
                          /*, _bookingClassHolder (NULL)*/ { }

    NetworkStructure (const NetworkStructure&);
    /** Destructor. */
...
#endif // __STDAIR_BOM_NETWORKSTRUCTURE_HPP
