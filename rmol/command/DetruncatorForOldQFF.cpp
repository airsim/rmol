...
namespace RMOL {
  ...
  unconstrain (const stdair::SegmentCabin& iSegmentCabin,
    ...
    // Update the forecasted demand of the booking class
  ...
  // ////////////////////////////////////////////////////////////////////
  void DetruncatorForOldQFF::unconstrain
  (const stdair::SegmentSnapshotTable& iSegmentSnapshotTable,
   ...
   stdair::UncDemVector_T& oDemand) {
    ...
    const stdair::ConstSegmentCabinDTDRangeSnapshotView_T& lBookingView =
      iSegmentSnapshotTable.getConstSegmentCabinDTDRangeBookingSnapshotView (lSegBegin, iNbOfUsableSegments -1, iDCPEnd, iDCPBegin);
    ...
    for (short i = 0; i < iNbOfUsableSegments-lSegBegin; ++i) {
      ...
      lNbOfHistoricalBkgsYesterday = lBookingView[i*lNbOfClasses + iClassIdx][lNbOfDTDs];
      lNbOfHistoricalBkgs += lBookingView[i*lNbOfClasses + iClassIdx][0] - lNbOfHistoricalBkgsYesterday;
      assert(iPSUp > 0);
