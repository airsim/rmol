...
void p3q12(Matrix pmat, double t, vector intens, int *degen);
void p3q14(Matrix pmat, double t, vector intens, int *degen);
void p3q16(Matrix pmat, double t, vector intens, int *degen);
void p3q124(Matrix pmat, double t, vector intens, int *degen);
void p3q135(Matrix pmat, double t, vector intens, int *degen);
void p3q1246(Matrix pmat, double t, vector intens, int *degen);

void p4q159(Matrix pmat, double t, vector intens, int *degen);
void p4q13569(Matrix pmat, double t, vector intens, int *degen);

void p5q1_6_11_16(Matrix pmat, double t, vector intens, int *degen); 
void p5q1_4_6_8_11_12_16(Matrix pmat, double t, vector intens, int *degen); 
void p5q1_6_7_11_12(Matrix pmat, double t, vector intens, int *degen); 

typedef void (*pfn)(Matrix pmat, double t, vector intens, int *degen);
...
{
    int i, j;
    vector intens_base = (vector) Calloc(nintens, double);
    Matrix pmat_base = (Matrix) Calloc( (nstates)*(nstates), double);
    for (i=0; i<nintens; ++i)
	intens_base[i] = intens[qperm[i]-1];
    if (nstates==2)
	(P2FNS[iso-1])(pmat_base, t, intens_base, degen);
    else if (nstates==3)
	(P3FNS[iso-1])(pmat_base, t, intens_base, degen);
    else if (nstates==4)
	(P4FNS[iso-1])(pmat_base, t, intens_base, degen);
    else if (nstates==5)
	(P5FNS[iso-1])(pmat_base, t, intens_base, degen);
...
void p3q124(Matrix pmat, double t, vector intens, int *degen)
{
    double a = intens[0], b = intens[1], c=intens[2]; 
    double e1 = exp(-((a + b)*t));
    double e2 = exp(-c*t);
    pmat[MI(0,0,3)] = e1;
...
void p3q1246(Matrix pmat, double t, vector intens, int *degen)
{
    double a = intens[0], b = intens[1], c=intens[2], d=intens[3]; 
    double e1 = exp(-((a + b)*t));    
    double e2 = exp(-((c + d)*t));
    pmat[MI(0,0,3)] = e1;
...
void p4q13569(Matrix pmat, double t, vector intens, int *degen){
  double a = intens[0], b = intens[1], c=intens[2], d=intens[3], e=intens[4]; 
  double e1 = exp(-((a + b)*t));
  double e2 = exp(-((c + d)*t));
  double e3 = exp(-(e*t));
  pmat[MI(0,0,4)] = e1;
...
void p5q1_4_6_8_11_12_16(Matrix pmat, double t, vector intens, int *degen){
    double a = intens[0], b = intens[1], c=intens[2], d=intens[3], e=intens[4], f=intens[5], g=intens[6];
    double e1 = exp(-((a + b)*t));
    double e2 = exp(-((c + d)*t));
    double e3 = exp(-((e + f)*t));
    double e4 = exp(-(g*t));
