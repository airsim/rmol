#ifndef __LATUS_COM_BOM_STRUCTABSTRACT_HPP
#define __LATUS_COM_BOM_STRUCTABSTRACT_HPP
...
operator<< (std::basic_ostream<charT, traits>& ioOut,
            const LATUS::COM::StructAbstract& iStruct) {
  /**
     string stream:
     - with same format
...
operator>> (std::basic_istream<charT, traits>& ioIn,
            LATUS::COM::StructAbstract& ioStruct) {
...
#endif // __LATUS_COM_BOM_STRUCTABSTRACT_HPP
